...
const Footer = () => {
  return (
    <motion.footer
      ...
      className="w-full  bg-white/75 shadow-xl shadow-cyan-700 dark:shadow-black dark:bg-gray-900 backdrop-blur-md border-t border-gray-200 dark:border-gray-700"
    >
      {/* Top Sections */}
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <li><a href="#" className="hover:text-cyan-500 dark:hover:text-cyan-300">About Us</a></li>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <li><a href="#" className="hover:text-cyan-500 dark:hover:text-cyan-300">Privacy Policy</a></li>
          </ul>
        </div>
