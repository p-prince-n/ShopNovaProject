  ...
  return (
    <div className="md:px-5 w-full flex items-center justify-center flex-col">
      ...
      <div
          ...
          } flex flex-col items-center justify-center shadow-2xl min-h-[70vh] py-12 px-4 text-center select-none bg-white dark:bg-[#071022] border border-slate-100 dark:border-slate-800 rounded-xl`}
        >
