...
const Profile = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center  mt-10 md:mt-20 left-0 overflow-x-auto px-2 md:px-10 xl:px-30  py-10 min-w-screen md:w-full">
        <div className="flex flex-1 flex-col md:flex-row justify-center items-start">
          {/* left sidebar */}
