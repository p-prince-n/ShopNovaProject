...
const CreateSellerPage = () => {
  ...
  // top-level checks
  const { shopName, shopDescription, categories, contactEmail, contactPhone, accountInfo } = sellerData;

  // check accountInfo fields
            ...
            <Input
              ...
              onChange={(e) => {
                setSellerData((prev) => ({
                  ...prev,
                  accountInfo:{
                    ...prev.accountInfo, upiId: e.target.value
                  },
                }));
              }}
            />
          ...
          <div className="flex gap-5 md:gap-10">
            ...
            <motion.button
                ...
                currentPage !== 2 && "hidden"
                        ...
                        onClick={SubmitData}
                      >
                       {loading ? <Loader className="animate-spin mx-auto" size={24} />: 'Verified'}
                      </motion.button>
          </div>
        </form>
      </div>
