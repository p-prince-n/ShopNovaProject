...
export default function HomePage() {
  ...
  useEffect(() => {
    fetchAllRandomProducts(); // fetch once on mount
  }, []);
  ...
  // ✅ toggle wishlist (lives in HomePage now)
  ...
  // Fetch discount products for all root categories
  useEffect(() => {
      ...
      <div className="px-5 sm:px-10 2xl:px-20 absolute flex flex-col gap-5 top-103 sm:top-118 md:top-136">
        <div className="flex flex-col gap-2 ">
          ...
          {Object.keys(categoryDiscountProducts).map((categoryName) => {
            ...
            if (!products || products.length === 0) return <div></div>; // Skip empty arrays
